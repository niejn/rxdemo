...
def test_group_by_with_key_comparer():
    ...
    results.messages.assert_equal(on_next(220, "foo"), on_next(270, "bar"), on_next(350, "baz"), on_next(360, "qux"),
                                  on_completed(570))
...
def test_groupby_outer_complete():
    ...
    key_invoked = 0
    ele_invoked = 0
    xs = scheduler.create_hot_observable(on_next(90, "error"), on_next(110, "error"), on_next(130, "error"),
                                         on_next(220, "  foo"), on_next(240, " FoO "), on_next(270, "baR  "),
                                         on_next(310, "foO "), on_next(350, " Baz   "), on_next(360, "  qux "),
                                         on_next(390, "   bar"), on_next(420, " BAR  "), on_next(470, "FOO "),
                                         on_next(480, "baz  "), on_next(510, " bAZ "), on_next(530, "    fOo    "),
                                         on_completed(570), on_next(580, "error"), on_completed(600),
                                         on_error(650, 'ex'))
...
def test_group_by_outer_error():
    ...
    xs = scheduler.create_hot_observable(on_next(90, "error"), on_next(110, "error"), on_next(130, "error"),
                                         ...
                                         on_next(390, "   bar"), on_next(420, " BAR  "), on_next(470, "FOO "),
                                         on_next(480, "baz  "), on_next(510, " bAZ "), on_next(530, "    fOo    "),
                                         on_error(570, ex), on_next(580, "error"), on_completed(600),
                                         on_error(650, 'ex'))
...
def test_group_by_inner_complete_all():
    ...
    scheduler.start()
    assert (len(inners) == 4)
    results['foo'].messages.assert_equal(on_next(220, "oof  "), on_next(240, " OoF "), on_next(310, " Oof"),
                                         on_next(470, " OOF"), on_next(530, "    oOf    "), on_completed(570))
    results['bar'].messages.assert_equal(on_next(270, "  Rab"), on_next(390, "rab   "), on_next(420, "  RAB "),
                                         on_completed(570))
    results['baz'].messages.assert_equal(on_next(350, "   zaB "), on_next(480, "  zab"), on_next(510, " ZAb "),
                                         on_completed(570))
